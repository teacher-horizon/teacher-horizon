...
fetch('./vocab.json')
    ...
    function phonewidth() {
        ...
        var iconClasses = ['fa-fire', 'fa-spell-check', 'fa-circle-plus', 'fa-circle-plus', 'fa-circle-plus', 'fa-pen'];
        ...
        if (screenWidth <= 767) {
            ...
            var linkContent = ['Warm-Up', 'Vocabulary', 'Past Aux', 'Simple Past', 'Practice'];
            for (var i = 0; i < links.length; i++) {
